function [allData, scenario, sensors] = EGO_Follow_Vehicle()
%EGO_Follow_Vehicle - Returns sensor detections
%    allData = EGO_Follow_Vehicle returns sensor detections in a structure
%    with time for an internally defined scenario and sensor suite.
%
%    [allData, scenario, sensors] = EGO_Follow_Vehicle optionally returns
%    the drivingScenario and detection generator objects.

% Generated by MATLAB(R) 9.5 and Automated Driving System Toolbox 1.3.
% Generated on: 28-Nov-2018 17:51:53

x = 0:10:100;
curvature = 1/100;
rateCurv = 1;
leadingDist = 20;
% y = 0.5*curvature.^2 + 1/6*rateCurv*x.^3;
y = sqrt(100^2 - x.^2);
plot(x,y,'.')
coords = [x' y', zeros(200,1)];
...
%     166.4 85.5 0.01];
speed = 20;
trajectory(egoCar, waypoints_follower, speed);
...
%     166.48 85.41 0.01];
speed = 20;
trajectory(truck, waypoints_leader, speed);
