...
ws_DIR = 'Y:\My Documents\Truck Pairing\Lateral Control\Simulation Tools\Matlab Scenario Designer\Data\v12\';
%Scene: S-Shape = 's'
...
cosRelHeading = cos(relativeHeading(1:706));
...
SigmaRightLane_plus = zeros(1,numel(unifiedStruct.timeVec)); % covariance after update
SigmaLeftLane_plus = zeros(1,numel(unifiedStruct.timeVec)); % covariance after update
clear rightLaneHeadingAngle_followerCorr
...
%             KF_update(leftLaneHeadingAngle_followerEst(i), SigmaLeftLane_min, leftLaneHeadingAngleMeasurement, sigma_measured);
        ...
        rightLaneHeadingAngle_followerCorr(i) = unifiedStruct.laneStats.rightLane.headingAngle.leaderValues(i) +...
...
% (sent.laneStats.rightLane.sentCurvature(i)*corrDistLeftLane(i) + 0.5*sent.laneStats.rightLane.sentCurvatureDerivative(i)*corrDistRightLane(i)^2);  
        ...
        leftLaneHeadingAngle_followerCorr(i) = unifiedStruct.laneStats.leftLane.headingAngle.leaderValues(i) + ...
...
newRelHeading = unifiedStruct.globalOrientation.Yaw.leaderValues - unifiedStruct.globalOrientation.Yaw.followerValues;
figure; hold on
plot(allTime,  unifiedStruct_followerAlone.laneStats.leftLane.headingAngle.followerValues(1:706))
plot(allTime, unifiedStruct.laneStats.rightLane.headingAngle.leaderValues(1:706))
plot(allTime, leftLaneHeadingAngle_followerCorr)
plot(allTime, newRelHeading(1:706), 'r--')
title('Left Lane')
figure; hold on
plot(allTime,  unifiedStruct_followerAlone.laneStats.rightLane.headingAngle.followerValues(1:706))
...
figure; hold on
subplot(2,2,1)
plot(allTime,  unifiedStruct.laneStats.leftLane.curvature.leaderValues(1:706) - unifiedStruct_followerAlone.laneStats.leftLane.curvature.followerValues(1:706))
title('curvature')
subplot(2,2,2)
plot(allTime,  unifiedStruct.laneStats.leftLane.curvatureDerivative.leaderValues(1:706) - unifiedStruct_followerAlone.laneStats.leftLane.curvatureDerivative.followerValues(1:706))
title('curvature derivative')
subplot(2,2,3:4)
% plot(allTime,  unifiedStruct.laneStats.rightLane.curvatureDerivative.leaderValues(1:706))
plot(allTime, leftLaneHeadingAngle_followerCorr' - unifiedStruct_followerAlone.laneStats.leftLane.headingAngle.followerValues(1:706))
title('heading')
...
hold on
grid on
plot(allTime, leftLaneRaw_unocludedFollowArea,'c','LineWidth',2)
...
hold on
grid on
plot(allTime, rightLaneRaw_unocludedFollowArea,'c','LineWidth',2)
