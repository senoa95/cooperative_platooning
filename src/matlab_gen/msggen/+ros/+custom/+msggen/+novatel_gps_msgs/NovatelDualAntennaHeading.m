classdef NovatelDualAntennaHeading < ros.Message
    %NovatelDualAntennaHeading MATLAB implementation of novatel_gps_msgs/NovatelDualAntennaHeading
    ...
    properties (Constant)
        MessageType = 'novatel_gps_msgs/NovatelDualAntennaHeading' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '9e80eaa83bf25f057aea59ce70d859e5' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'BaselineLength', 'ExtendedSolutionStatus', 'Header', 'Heading', 'HeadingSigma', 'NovatelMsgHeader', 'NumSatellitesAboveElevationMaskAngle', 'NumSatellitesAboveElevationMaskAngleL2', 'NumSatellitesTracked', 'NumSatellitesUsedInSolution', 'Pitch', 'PitchSigma', 'PositionType', 'SignalMask', 'SolutionSource', 'SolutionStatus', 'StationId'} % List of non-constant message properties
        ROSPropertyList = {'baseline_length', 'extended_solution_status', 'header', 'heading', 'heading_sigma', 'novatel_msg_header', 'num_satellites_above_elevation_mask_angle', 'num_satellites_above_elevation_mask_angle_l2', 'num_satellites_tracked', 'num_satellites_used_in_solution', 'pitch', 'pitch_sigma', 'position_type', 'signal_mask', 'solution_source', 'solution_status', 'station_id'} % List of non-constant ROS message properties
    end
    
    methods
        function obj = NovatelDualAntennaHeading(msg)
            %NovatelDualAntennaHeading Construct the message object NovatelDualAntennaHeading
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'NovatelDualAntennaHeading', 'Header');
        ...
        function set.NovatelMsgHeader(obj, novatelmsgheader)
            ...
            validateattributes(novatelmsgheader, {obj.NovatelGpsMsgsNovatelMessageHeaderClass}, {'nonempty', 'scalar'}, 'NovatelDualAntennaHeading', 'NovatelMsgHeader');
        ...
        function set.SolutionStatus(obj, solutionstatus)
            ...
            validateattributes(solutionstatus, {'char', 'string'}, {}, 'NovatelDualAntennaHeading', 'SolutionStatus');
        ...
        function set.PositionType(obj, positiontype)
            ...
            validateattributes(positiontype, {'char', 'string'}, {}, 'NovatelDualAntennaHeading', 'PositionType');
        ...
        function set.BaselineLength(obj, baselinelength)
            ...
            validateattributes(baselinelength, {'numeric'}, {'nonempty', 'scalar'}, 'NovatelDualAntennaHeading', 'BaselineLength');
        ...
        function set.Heading(obj, heading)
            ...
            validateattributes(heading, {'numeric'}, {'nonempty', 'scalar'}, 'NovatelDualAntennaHeading', 'Heading');
        ...
        function set.Pitch(obj, pitch)
            ...
            validateattributes(pitch, {'numeric'}, {'nonempty', 'scalar'}, 'NovatelDualAntennaHeading', 'Pitch');
        ...
        function set.HeadingSigma(obj, headingsigma)
            ...
            validateattributes(headingsigma, {'numeric'}, {'nonempty', 'scalar'}, 'NovatelDualAntennaHeading', 'HeadingSigma');
        ...
        function set.PitchSigma(obj, pitchsigma)
            ...
            validateattributes(pitchsigma, {'numeric'}, {'nonempty', 'scalar'}, 'NovatelDualAntennaHeading', 'PitchSigma');
        ...
        function set.StationId(obj, stationid)
            ...
            validateattributes(stationid, {'char', 'string'}, {}, 'NovatelDualAntennaHeading', 'StationId');
        ...
        function set.NumSatellitesTracked(obj, numsatellitestracked)
            ...
            validateattributes(numsatellitestracked, {'numeric'}, {'nonempty', 'scalar'}, 'NovatelDualAntennaHeading', 'NumSatellitesTracked');
        ...
        function set.NumSatellitesUsedInSolution(obj, numsatellitesusedinsolution)
            ...
            validateattributes(numsatellitesusedinsolution, {'numeric'}, {'nonempty', 'scalar'}, 'NovatelDualAntennaHeading', 'NumSatellitesUsedInSolution');
        ...
        function set.NumSatellitesAboveElevationMaskAngle(obj, numsatellitesaboveelevationmaskangle)
            ...
            validateattributes(numsatellitesaboveelevationmaskangle, {'numeric'}, {'nonempty', 'scalar'}, 'NovatelDualAntennaHeading', 'NumSatellitesAboveElevationMaskAngle');
        ...
        function set.NumSatellitesAboveElevationMaskAngleL2(obj, numsatellitesaboveelevationmaskanglel2)
            ...
            validateattributes(numsatellitesaboveelevationmaskanglel2, {'numeric'}, {'nonempty', 'scalar'}, 'NovatelDualAntennaHeading', 'NumSatellitesAboveElevationMaskAngleL2');
        ...
        function set.SolutionSource(obj, solutionsource)
            ...
            validateattributes(solutionsource, {'numeric'}, {'nonempty', 'scalar'}, 'NovatelDualAntennaHeading', 'SolutionSource');
        ...
        function set.ExtendedSolutionStatus(obj, extendedsolutionstatus)
            ...
            validateattributes(extendedsolutionstatus, {obj.NovatelGpsMsgsNovatelExtendedSolutionStatusClass}, {'nonempty', 'scalar'}, 'NovatelDualAntennaHeading', 'ExtendedSolutionStatus');
        ...
        function set.SignalMask(obj, signalmask)
            ...
            validateattributes(signalmask, {obj.NovatelGpsMsgsNovatelSignalMaskClass}, {'nonempty', 'scalar'}, 'NovatelDualAntennaHeading', 'SignalMask');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.novatel_gps_msgs.NovatelDualAntennaHeading.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.novatel_gps_msgs.NovatelDualAntennaHeading;
            obj.reload(strObj);
        end
    end
end
